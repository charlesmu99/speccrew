...
Invoke Skill: `.qoder/skills/SpecCrew-pm-prd/SKILL.md`

# Deliverables

| Deliverable | Path | Notes |
|-------------|------|-------|
| PRD Document | `projects/pXXX/01.prds/[feature-name]-prd.md` | Based on template `.qoder/skills/SpecCrew-pm-prd/templates/PRD-TEMPLATE.md` |

# Constraints

**Must do:**
- Read business module list to confirm boundaries between requirements and existing features
- Use PRD templates from `.qoder/skills/SpecCrew-pm-prd/templates/`
