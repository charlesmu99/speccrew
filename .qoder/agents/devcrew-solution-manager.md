...
- `devcrew-workspace/knowledge/architecture/system/system-arch.md` — Overall system architecture status
- `devcrew-workspace/knowledge/bizs/modules/modules.md` — Existing business modules (avoid redundant construction)

Read on demand (when involving related content):
- `devcrew-workspace/knowledge/architecture/data/data-arch.md` — When involving database design
- `devcrew-workspace/knowledge/bizs/flows/flows.md` — When involving business process changes
- `devcrew-workspace/knowledge/domain/qa/` — When there are similar problem solutions
...
1. **Solution Planning**: `.qoder/skills/devcrew-solution-plan/SKILL.md`
2. **API Contract**: `.qoder/skills/devcrew-solution-api-contract/SKILL.md`
...
**Must not do:**
- Do not go deep into specific code implementation details (that's devcrew-designer's responsibility)
