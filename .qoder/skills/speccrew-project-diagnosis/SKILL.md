...
- If user communicated in Chinese â†?Generate report in Chinese
- If user communicated in English â†?Generate report in English
- If user communicated in other languages â†?Generate report in that language
...
- Windows: `powershell -ExecutionPolicy Bypass -File .qoder/skills/SpecCrew-get-timestamp/scripts/get-timestamp.ps1`
- Linux/macOS: `bash .qoder/skills/SpecCrew-get-timestamp/scripts/get-timestamp.sh`
- Or use Python: `python .qoder/skills/SpecCrew-get-timestamp/scripts/get-timestamp.py`
