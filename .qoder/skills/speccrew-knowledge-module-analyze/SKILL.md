...
For each feature, use template `.qoder/skills/SpecCrew-knowledge-module-analyze/templates/feature-detail-template.md`:
...
Use template `.qoder/skills/SpecCrew-knowledge-module-analyze/templates/module-overview-template.md`, fill sections:
