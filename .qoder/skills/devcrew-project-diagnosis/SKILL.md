...
**Diagnosis Report Output**: `devcrew-workspace/docs/diagnosis-reports/diagnosis-report-{YYYY-MM-DD-HHmm}.md`
...
Ensure `devcrew-workspace/docs/diagnosis-reports/` directory exists.
