...
```
order/
  â””â”€â”€ order-overview.md
payment/
  â””â”€â”€ payment-overview.md
inventory/
  â””â”€â”€ inventory-overview.md
```
...
Use template `.qoder/skills/SpecCrew-knowledge-system-summarize/templates/system-overview-template.md`, fill all sections:
