...
3. 前端架构规范：`.devcrew-workspace/knowledge/architecture/frontend/README.md`
4. 前端设计模板：`.qoder/skills/devcrew-design-frontend/templates/DESIGN-TEMPLATE.md`

## 步骤二：分析现有代码结构（按需）

如需了解现有组件或 API 封装，通过 semantic-searcher 或直接读取：
