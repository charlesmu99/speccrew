...
- Automatically triggered by devcrew-solution-plan Skill after Solution document completion
...
2. API Contract template: `.qoder/skills/devcrew-solution-api-contract/templates/API-CONTRACT-TEMPLATE.md`
3. System architecture (API specification part): `devcrew-workspace/knowledge/architecture/backend/README.md` (refer to API naming conventions)
...
- Follow API specifications in `devcrew-workspace/knowledge/architecture/backend/README.md`
