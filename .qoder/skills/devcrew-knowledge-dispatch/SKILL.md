...
- Task status records in `devcrew-workspace/docs/crew-init/knowledge-bizs/` and/or `devcrew-workspace/docs/crew-init/knowledge-techs/`
...
**Action**:
- Invoke 1 Worker Agent (`.qoder/agents/devcrew-task-worker.md`) with skill `.qoder/skills/devcrew-knowledge-techs-init/SKILL.md`
- Task: Analyze project structure, detect technology platforms
- Parameters to pass to skill:
  - `source_path`: Source code directory path
  - `output_path`: Output directory (default: `devcrew-workspace/docs/crew-init/knowledge-techs/`)
  - `language`: User's language (e.g., "zh", "en") - **REQUIRED**

**Output**:
- `devcrew-workspace/docs/crew-init/knowledge-techs/techs-manifest.json`
...
**Action**:
- Read `devcrew-workspace/docs/crew-init/knowledge-techs/techs-manifest.json`
- For each platform in `platforms` array, invoke 1 Worker Agent (`.qoder/agents/devcrew-task-worker.md`) with skill `.qoder/skills/devcrew-knowledge-techs-generate/SKILL.md`
- Parameters to pass to skill:
...
subagent_type: "devcrew-task-worker"
description: "Generate web-react technology documents"
prompt: |
  skill_path: .qoder/skills/devcrew-knowledge-techs-generate/SKILL.md
  context:
    platform_id: web-react
    platform_type: web
    framework: react
...
**Status Tracking**:
- `devcrew-workspace/docs/crew-init/knowledge-techs/stage2-status.json`
...
**Action**:
- Read `devcrew-workspace/docs/crew-init/knowledge-techs/techs-manifest.json`
- Invoke 1 Worker Agent (`.qoder/agents/devcrew-task-worker.md`) with skill `.qoder/skills/devcrew-knowledge-techs-index/SKILL.md`
- Parameters to pass to skill:
...
- Launch Bizs Stage 1 Worker (devcrew-knowledge-bizs-init)

**IF knowledge_types = "techs" OR "both"**:
- Launch Techs Stage 1 Worker (devcrew-knowledge-techs-init)
