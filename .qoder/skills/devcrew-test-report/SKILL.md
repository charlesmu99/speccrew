...
4. Testing Conventions: `devcrew-workspace/knowledge/architecture/conventions/testing.md`
...
Read template: `.qoder/skills/devcrew-test-report/templates/TEST-REPORT-TEMPLATE.md`
