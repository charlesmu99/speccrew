---
name: devcrew-knowledge-techs-generate
...
- `.qoder/skills/devcrew-knowledge-techs-generate/templates/{platform-type}-{framework}/`
- Fallback: `.qoder/skills/devcrew-knowledge-techs-generate/templates/generic/`
