...
3. 开发规范：`.devcrew-workspace/knowledge/architecture/conventions/conventions.md`
4. 任务记录模板：`.qoder/skills/devcrew-dev-task/templates/TASK-[FRONTEND|BACKEND]-TEMPLATE.md`
...
如实际实现与设计有偏差（无论什么原因），记录到任务文件的"偏差说明"章节：
...
- [ ] 命名符合规范
- [ ] 所有偏差已记录
- [ ] 如有技术债，已写入 `projects/pXXX/tech-debt/[功能名]-tech-debt.md`（基于模板 `.qoder/skills/devcrew-dev-task/templates/TECH-DEBT-TEMPLATE.md`）
- [ ] 任务记录状态已更新为完成
