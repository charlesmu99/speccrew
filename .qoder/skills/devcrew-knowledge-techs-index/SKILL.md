---
name: devcrew-knowledge-techs-index
...
|------------|------------|-------------------|
| Designer | devcrew-designer-web-react | [knowledge/techs/web-react/](web-react/) |
| Developer | devcrew-dev-web-react | [knowledge/techs/web-react/](web-react/) |
| Tester | devcrew-test-web-react | [knowledge/techs/web-react/](web-react/) |
...
| Agent Role | Agent Name | Documentation Path |
|------------|------------|-------------------|
| Designer | devcrew-designer-backend-nestjs | [knowledge/techs/backend-nestjs/](backend-nestjs/) |
| Developer | devcrew-dev-backend-nestjs | [knowledge/techs/backend-nestjs/](backend-nestjs/) |
| Tester | devcrew-test-backend-nestjs | [knowledge/techs/backend-nestjs/](backend-nestjs/) |
...
Use template at `.qoder/skills/devcrew-knowledge-techs-index/templates/INDEX-TEMPLATE.md`:
