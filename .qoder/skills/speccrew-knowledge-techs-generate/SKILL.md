...
- `.qoder/skills/SpecCrew-knowledge-techs-generate/templates/{platform-type}-{framework}/`
- Fallback: `.qoder/skills/SpecCrew-knowledge-techs-generate/templates/generic/`
