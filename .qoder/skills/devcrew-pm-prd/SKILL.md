...
```
devcrew-workspace/projects/p[number]-[iteration-name]/01.prds/[feature-name]-prd.md
```
...
```
PRD generated: devcrew-workspace/projects/pXXX/01.prds/[feature-name]-prd.md
