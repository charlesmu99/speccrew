...
description: Dispatch bizs knowledge base generation tasks with 4-stage pipeline. Handles feature inventory, feature analysis with skill routing, graph data writing, module summarization, and system summary.
tools: Read, Write, Task, Bash
---

# Bizs Knowledge Dispatch

Orchestrate **bizs knowledge base generation** with a 4-stage pipeline: Feature Inventory → Feature Analysis + Graph Write → Module Summarize → System Summary.
...
After all 4 stages complete, return a summary object to the caller:
