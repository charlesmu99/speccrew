...
SpecCrew هو إطار عمل مدمج لفريق تطوير افتراضي بالذكاء الاصطناعي، مبني على [Qoder](https://qoder.com/). يحول سير عمل هندسة البرمجيات المهنية (PRD → Solution → Design → Dev → Test) إلى سير عمل وكلاء (Agent) قابلة لإعادة الاستخدام، مما يساعد فرق التطوير على تحقيق التطوير المدفوع بالمواصفات (SDD).
