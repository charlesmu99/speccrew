...
### 3.2 ব্যবসায়িক জ্ঞান ভিত্তি শুরু করা
...
## 6. ওয়ার্কফ্লো প্রগ্রেস ম্যানেজমেন্ট

SpecCrew ভার্চুয়াল টিম একটি কঠোর স্টেজ-গেটিং মেকানিজম অনুসরণ করে যেখানে প্রতিটি ধাপ অবশ্যই ব্যবহারকারীর দ্বারা নিশ্চিত হতে হবে পরবর্তী ধাপে যাওয়ার আগে। এটি পুনরায় শুরু করার যোগ্য এক্সিকিউশনও সমর্থন করে — বাধার পরে পুনরায় শুরু করলে, এটি স্বয়ংক্রিয়ভাবে যেখানে থেমেছিল সেখান থেকে চালিয়ে যায়।

### 6.1 তিন-স্তরের প্রগ্রেস ফাইল

ওয়ার্কফ্লো স্বয়ংক্রিয়ভাবে তিন ধরনের JSON প্রগ্রেস ফাইল বজায় রাখে, যা ইটারেশন ডিরেক্টরিতে অবস্থিত:

| ফাইল | অবস্থান | উদ্দেশ্য |
|------|----------|----------|
| `WORKFLOW-PROGRESS.json` | `iterations/{iter}/` | প্রতিটি পাইপলাইন ধাপের অবস্থা রেকর্ড করে |
| `.checkpoints.json` | প্রতিটি ধাপ ডিরেক্টরির অধীনে | ব্যবহারকারী চেকপয়েন্ট নিশ্চিতকরণ অবস্থা রেকর্ড করে |
| `DISPATCH-PROGRESS.json` | প্রতিটি ধাপ ডিরেক্টরির অধীনে | সমান্তরাল কাজের জন্য আইটেম-বাই-আইটেম প্রগ্রেস রেকর্ড করে (বহু-প্ল্যাটফর্ম/বহু-মডিউল) |

### 6.2 ধাপ অবস্থা প্রবাহ

প্রতিটি ধাপ এই অবস্থা প্রবাহ অনুসরণ করে:
...
- **in_progress**: বর্তমানে এক্সিকিউট হচ্ছে
- **completed**: এজেন্ট এক্সিকিউশন সম্পন্ন, ব্যবহারকারীর নিশ্চিতকরণের অপেক্ষায়
- **confirmed**: ব্যবহারকারী চূড়ান্ত চেকপয়েন্টের মাধ্যমে নিশ্চিত করেছে, পরবর্তী ধাপ শুরু হতে পারে

### 6.3 পুনরায় শুরু করার যোগ্য এক্সিকিউশন

একটি ধাপের জন্য এজেন্ট পুনরায় শুরু করার সময়:

1. **স্বয়ংক্রিয় আপস্ট্রিম চেক**: পূর্ববর্তী ধাপ নিশ্চিত কিনা যাচাই করে, না হলে ব্লক করে এবং অনুরোধ করে
2. **চেকপয়েন্ট পুনরুদ্ধার**: `.checkpoints.json` পড়ে, অতিক্রান্ত চেকপয়েন্টগুলি এড়িয়ে যায়, শেষ বাধার বিন্দু থেকে চালিয়ে যায়
3. **সমান্তরাল কাজ পুনরুদ্ধার**: `DISPATCH-PROGRESS.json` পড়ে, শুধুমাত্র `pending` বা `failed` অবস্থার কাজগুলি পুনরায় এক্সিকিউট করে, `completed` কাজগুলি এড়িয়ে যায়

### 6.4 বর্তমান প্রগ্রেস দেখুন

টিম লিডার এজেন্টের মাধ্যমে পাইপলাইন প্যানোরামা অবস্থা দেখুন:

```
@speccrew-team-leader বর্তমান ইটারেশন প্রগ্রেস দেখুন
```

টিম লিডার প্রগ্রেস ফাইলগুলি পড়বে এবং অনুরূপ একটি অবস্থা ওভারভিউ দেখাবে:
...
### 6.5 পশ্চাদগামী সামঞ্জস্যতা

প্রগ্রেস ফাইল মেকানিজম সম্পূর্ণরূপে পশ্চাদগামী সামঞ্জস্যপূর্ণ — যদি প্রগ্রেস ফাইলগুলি বিদ্যমান না থাকে (যেমন, পুরানো প্রকল্পে বা নতুন ইটারেশনে), সমস্ত এজেন্ট মূল যুক্তি অনুযায়ী স্বাভাবিকভাবে এক্সিকিউট করবে।
...
### প্র৫: `speccrew update` নতুন সংস্করণ দেখাচ্ছে কিন্তু ইনস্টলেশনের পরও পুরানো সংস্করণ?

সাধারণত npm ক্যাশের কারণে হয়। সমাধান:
...
যদি এখনও কাজ না করে, সংস্করণ নম্বর নির্দিষ্ট করুন:
```bash
npm install -g speccrew@0.5.6
```

### প্র৬: ঐতিহাসিক ইটারেশন কীভাবে দেখবেন?

আর্কাইভ করার পরে, `speccrew-workspace/iteration-archives/` এ দেখুন, `{নম্বর}-{টাইপ}-{নাম}-{তারিখ}/` ফরম্যাটে সংগঠিত।

### প্র৭: জ্ঞান ভিত্তির নিয়মিত আপডেট প্রয়োজন?
...
2. জ্ঞান ভিত্তি শুরু করা সম্পাদন করুন
